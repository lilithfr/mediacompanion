...
Public Class TvShow
    ...
    Public Property MaxEpisodeCount As New ProtoProperty(Me, "max")
    ...
    Public Sub AddEpisode(ByRef Episode As TvEpisode)
        ...
        If IsNothing(Me.MaxEpisodeCount.Value) Then
            Me.MaxEpisodeCount.Value = Episode.Episode.Value
        ElseIf Integer.Parse(Episode.Episode.Value) > Integer.Parse(Me.MaxEpisodeCount.Value) Then
            Me.MaxEpisodeCount.Value = Episode.Episode.Value
        End If
