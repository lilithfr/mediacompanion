...
Public Class ProtoProperty
    ...
    Public Sub New(ByRef Parent As IProtoXBase, ByVal NodeName As String, Optional ByVal DefaultValue As String = Nothing, Optional ByVal SortOrder As Integer = -1, Optional ByVal ExtraNodes As String() = Nothing)
