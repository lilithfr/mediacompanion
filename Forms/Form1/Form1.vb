        ...
        Try
            ...
            For Each thisresult In doc("relativepaths")
                ...
                For Each innerresult In thisresult
                    ...
                    End Select
                Next
                If Not String.IsNullOrEmpty(newfo.mc) Then
                    If Not String.IsNullOrEmpty(newfo.xbmc) Then
...
'       Assign_FilterActor
 ...
 '       mov_FormPopulate()
    ...
    Private Function TriStateFilter_OnFormatItem(ByVal item As String) As String Handles cbFilterGenre.OnFormatItem, cbFilterCertificate.OnFormatItem,
                                                                                    ...
                                                                                    cbFilterStudios.OnFormatItem, cbFilterRootFolder.OnFormatItem, cbFilterUserRated.OnFormatItem
