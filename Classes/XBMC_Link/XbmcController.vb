...
#Region "Event Handlers"
 ...
 '       WatchDogTimer.Stop
        ...
        If evt.EventID=e.XBMC_Video_ScanFinished Then
            LogWarning("UnexpectedEvent", "State : [" + evt.SourceStateID.ToString + "] Ignoring unexpected event : [" + evt.EventID.ToString + "]",evt)
            Return
        End If
...
#Region "Actions"
  ...
  '      WatchDogTimer.Stop
    ...
    Sub Raise_XbmcQuit(sender As Object, args As TransitionEventArgs(Of S, E, EventArgs))
        XbmcJson.xbmc.Close
        LogInfo("XBMC is not longer running",args)
   ...
   End Sub
    ...
    Sub Retry(sender As Object, args As TransitionEventArgs(Of S, E, EventArgs))
        ...
        LogInfo("Resubmitting last MC event : [" + le.E.ToString +"] Retry number : [" + le.Retries.ToString + "]",args)
        BufferQ.Write(le)
    End Sub
