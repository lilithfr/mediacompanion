...
Public Class ucGenPref_XbmcLink
    ...
    Public Sub Pop
        ...
        AppendDialogue(" - The quickest & easiestway to synchronize all movies is to select them all in the movies list and click the Save button")
        ...
        AppendDialogue(" - If you find a link bug & are going to raise an issue, please include the log file: XBMC-Controller-log-file.txt")
        AppendDialogue("")
